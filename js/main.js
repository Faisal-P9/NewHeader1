    ...
    document.addEventListener('readystatechange', function() {
      ...
      let tHeader = gsap.timeline({ paused: true})
        ...
        tHeader
        .add('sta')
        .to('#sun2', { duration: 1, y: '20%', x: '0%', opacity: 1, ease: "power4.in" }, 'sta')
        .fromTo('.header__masking--maskLayer', { opacity: 0 }, {duration: 0.6, stagger: 0.04, opacity: 1, ease: 'expo.in'}, 'sta')
        // .fromTo('.header__masking--maskLayer', { opacity: 0 }, {duration: 0.0001, stagger: 0.04, opacity: 1, ease: 'expo.in'})

        .add('head')
        .to('.header__masking, #sun2', { duration: 0, opacity: 0, ease: "none" }, 'head')
    ...
    // })
      ...
      $(window).scroll(function () {
        ...
        if( !(value >= 820) ) {
          ...
          header_text.style.marginTop = value * 0.4 + 'px';
          grass.style.marginTop = value * -0.12 + 'px';
          sun.style.marginBottom = value * -0.4 + 'px';
        }
